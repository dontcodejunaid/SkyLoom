...
/**
 * SkyToggle — Day/Night mode switch from 21st.dev
 *
 * Props:
 *   checked  {boolean}  — controlled: true = night mode
 *   onChange {function} — called with the new boolean value on toggle
 */
const SkyToggle = ({ checked, onChange }) => {
  ...
  return (
    <StyledWrapper>
      <label className="theme-switch" title={checked ? 'Switch to day mode' : 'Switch to night mode'}>
        <input
          type="checkbox"
          className="theme-switch__checkbox"
          checked={checked}
          onChange={handleChange}
          id="sky-toggle-checkbox"
